...
create table t_crawler_pages (url varchar(255) not null, html text not null, sign varchar(255) not null, charset varchar(10), title varchar(100), keywords varchar(255), description varchar(255), isCreateIndex bit, execDate timestamp,primary key (url, sign));